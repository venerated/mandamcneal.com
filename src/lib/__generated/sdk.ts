...
export type ContentfulPageBuilderCollectionFieldsFragment = (
  { __typename?: 'PageBuilder', title?: string | null, description?: string | null, date?: any | null, copy?: string | null, tags?: Array<string | null> | null, thumbnail?: { __typename?: 'Asset', url?: string | null, width?: number | null, height?: number | null } | null }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    globalSettings(variables?: ContentfulGlobalSettingsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ContentfulGlobalSettingsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ContentfulGlobalSettingsQuery>({ document: GlobalSettingsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'globalSettings', 'query', variables);
    },
    pageBuilder(variables: ContentfulPageBuilderQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ContentfulPageBuilderQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ContentfulPageBuilderQuery>({ document: PageBuilderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'pageBuilder', 'query', variables);
    },
    pageBuilderCollectionList(variables?: ContentfulPageBuilderCollectionListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ContentfulPageBuilderCollectionListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ContentfulPageBuilderCollectionListQuery>({ document: PageBuilderCollectionListDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'pageBuilderCollectionList', 'query', variables);
    },
    pageBuilderCollection(variables?: ContentfulPageBuilderCollectionQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ContentfulPageBuilderCollectionQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ContentfulPageBuilderCollectionQuery>({ document: PageBuilderCollectionDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'pageBuilderCollection', 'query', variables);
    }
  };
}
